...
bool isSame(DoublyLinkedListNode* list1,DoublyLinkedListNode* list2) {
    if(sizeOfList(list1) == 1 && sizeOfList(list2) == 1) {
        if(list1->data == list2->data) {
            return true;
        }
        return false;
    }
   else if(sizeOfList(list1) != sizeOfList(list2)) {
        return false;
    }else {
...
int main()
{
    ...
    DoublyLinkedListNode* tail1 = NULL;
    DoublyLinkedListNode* head2 = NULL;
    DoublyLinkedListNode* tail2 = NULL;
